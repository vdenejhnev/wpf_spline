...
namespace classes
{
    ...
    public class SplineData
    {
        ...
        public void ApproximateSpline()
        {
            ...
            double[] CubicSmallSplineValues = new double[SmallSplineNodes];
            ...
            {
                XSmallSpline[i] = DataArray.Borders[0] + (i) * ((DataArray.Borders[1] - DataArray.Borders[0]) / SmallSplineNodes);
                YSmallSpline[i] = DataArray.Function(XSmallSpline[i], 0);
            }

            ret = CubicSpline(XSmallSpline.Length, SmallSplineNodes, IterationsNumber, XSmallSpline, YSmallSpline, CubicSmallSplineValues, ref residualNorm, ref iterationCompleted, ref stoppingReason);
            ...
            for (int i = 0; i < SmallSplineNodes; i++)
            {
                ResultsSmallGrid.Add(new double[2] { XSmallSpline[i], CubicSmallSplineValues[i] });
            }
        }
